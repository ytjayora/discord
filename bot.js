...
client.on('message', msg => {
  if (msg.content.toLowerCase() === prefix + 'davet') {
    ...
    .addField(msg.author.username, 'Özel mesajlarını kontrol et. :postbox:');
    msg.channel.sendEmbed(ozelmesajkontrol) }
      msg.author.sendMessage("Link: https://discordapp.com/oauth2/authorize?client_id=543166523678785536&scope=bot&permissions=2146958847").then(message => console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] Gönderilen mesaj: ${message.content}`)).catch(console.error);
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === prefix + 'bilgi') {
    ...
    .addField(msg.author.username, 'Özel mesajlarını kontrol et. :postbox:');
    msg.channel.sendEmbed(ozelmesajkontrol) }
      msg.author.sendMessage('Bot sürümü: v' + ayarlar.surum + ' Yapımcı: Jayora **Sohbet ve Oyun**\n\n_**BOTU EKLEMEK İÇİN LİNK:** https://discordapp.com/oauth2/authorize?client_id=543166523678785536&scope=bot&permissions=2146958847 \n\n_**Linkler:**_\n\n**Sohbet ve Oyun** sunucusunun davet linki: https://discord.gg/vSAMvdG \nBotun davet linki: https://discordapp.com/oauth2/authorize?client_id=543166523678785536&scope=bot&permissions=2146958847 Sohbet ve Oyun**').then(message => console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] Gönderilen mesaj: ${message.content}`)).catch(console.error);
  }
});
...
const girismesaj = [
  ...
  'Bot Jayora tarafından geliştirilmektedir ',
  ...
  '',
  `**Sohbet ve Oyun BOT Resmî Discord Sunucusu** https://discord.gg/vSAMvdG`,
  `**BOT Davet Link** https://discordapp.com/oauth2/authorize?client_id=543166523678785536&scope=bot&permissions=2146958847`
]
